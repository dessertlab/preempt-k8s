        ...
        try:
            ...
            if controller_name == 'kube-manager':
                ...
                events.append({
                    ...
                    'timestamp': metrics['starts_processing_timestamp'] - scale_up_ts
                })
            else:
                ...
                events.append({
                    'type': 'pod_created',
                    'timestamp': metrics['pod_created_timestamp'] - scale_up_ts
                })
            
            events.append({
                'type': 'pod_started',
                'timestamp': metrics['pod_started_timestamp'] - scale_up_ts
            })
