...
//We use a specific version to find our Custom Pods not releted to what Knative expect to be there
/*
...
func (r *reconciler) getSelector(sks *netv1alpha1.ServerlessService) (map[string]string, error) {
    return map[string]string{
        "serving.knative.dev/revision": sks.Labels["serving.knative.dev/revision"],
    }, nil
}
