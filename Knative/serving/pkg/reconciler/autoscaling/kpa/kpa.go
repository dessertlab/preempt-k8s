...
type Reconciler struct {
	*areconciler.Base
	...
	//scaler     *scaler
	scaler     *rtscaler.RTScaler  //Changed from *scaler to *rtscaler.RTScaler
}
...
func (c *Reconciler) ReconcileKind(ctx context.Context, pa *autoscalingv1alpha1.PodAutoscaler) pkgreconciler.Event {
	...
	*/
	want := c.scaler.Scale(ctx, pa, decider.Status.DesiredScale) //This call uses our RTScaler instead of the vanilla one
